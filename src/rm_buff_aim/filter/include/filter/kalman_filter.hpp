...
namespace filter
{
    ...
    class KalmanFilter
    {
        public:
            ...
            virtual void updateF(Eigen::MatrixXd& Ft) 
            {
                Ft = F_;
            }
            ...
            */
            ...
            virtual void updateH(Eigen::MatrixXd& Ht)
            {
                Ht = H_; 
            }
            ...
            virtual void updateJf(Eigen::MatrixXd& Jft)
            {
                Jft = Jf_;
            }
            ...
            */
            ...
            virtual void updateJh(Eigen::MatrixXd& Jht)
            {
                Jht = Jh_;
            }
