...
@return z:m
*/
float Predictor::monoDirectionalAirResistanceModel(float s, float v, float angle)
{
    float z;
    //t为给定v与angle时的飞行时间
...
*/
//TODO 完整弹道模型
float Predictor::completeAirResistanceModel(float s, float v, float angle)
{
...
*/
float Predictor::pitchTrajectoryCompensation(float s, float z, float v)
{
...
*/
void Predictor::autoSolveTrajectory(float *pitch, float *yaw, float *aim_x, float *aim_y, float *aim_z)
{
