  ...
  serial_driver_{new drivers::serial_driver::SerialDriver(*owned_ctx_)}
{
  ...
  state_pub_ = this->create_publisher<auto_aim_interfaces::msg::State>("/state", 10);
  ...
  // Create Subscription
  aiming_sub_ = this->create_subscription<auto_aim_interfaces::msg::Aiming>(
...
void RMSerialDriver::sendData(const auto_aim_interfaces::msg::Aiming::SharedPtr msg)
{
